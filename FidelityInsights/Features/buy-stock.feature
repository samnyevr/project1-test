...
Feature: Trading - Buy Stock
    ...
    Scenario: Buy a stock successfully
        ...
        And the trader is shown a confirmation message "Successfully bought 100 shares of AAL at $6.00"
    ...
    Scenario: Buy a stock successfully with Maximum Quantity
        ...
        And the available balance should be reduced accordingly
        And the trader is shown a confirmation message "Successfully bought 1666666 shares of AAL at $6.00"
